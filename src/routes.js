...
const CarVerification = React.lazy(() => import('./views/base/car-verification/car-verification'))
...
const routes = [
  ...
  { path: '/base/car-verification', name: 'CarVerification', element: CarVerification },
